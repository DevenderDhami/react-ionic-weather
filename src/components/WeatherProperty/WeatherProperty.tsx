...
import {  cloudy,  pulseOutline, sunnyOutline, thermometerOutline } from "ionicons/icons";
import { useEffect, useState } from "react";

export const WeatherProperty = ({ type, currentWeather }: any) => {

    const [property, setProperty] = useState(false) as any;
